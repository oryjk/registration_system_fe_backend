<template>
  <div class="max-width-container">
    <el-container class="h-screen" v-loading="isLoading" element-loading-text="数据加载中……">
      ...
      <el-main v-if="isLoading" class="p-6 bg-gray-50">
      </el-main>
      <el-main v-else class="p-6 bg-gray-50">
        <router-view/>
      </el-main>
    </el-container>
  </div>
...
import {Clock, Document, List, Refresh, Setting, User} from '@element-plus/icons-vue'
...
const activePath = computed(() => {
  return route.path === '/' ? '/create-competition' : route.path;
});
